...
> Solrais is a powerful multi-server Discord bot for **macro session tracking**, **AI-powered chat**, **biome relay systems**, and **community management** — built for Sol's RNG and similar Roblox macro communities.
